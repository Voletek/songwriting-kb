...
1. Update `references/KEEPER_OF_THE_LIGHT_BIBLE.md` with new track registry
...
2. **D Mixolydian = T1 and T8 ONLY** — keeper's identity key, protected
3. **Fm = Track 7 ONLY** — creature's key, never borrowed
...
|---|---|
| 1-2 | Warm acoustic folk, concertina, bodhran, sea-wash, close-mic vocal |
| 3 | Darkened folk, fingerpicked guitar, bowed drone, whispered harmony |
| 4 | Dark ambient + folk bones, sub-bass, reversed choir |
| 5 | Storm percussion, distorted fiddle, desperate vocal, chaos |
| 6 | Near-silence, drone ambient, whale-song bass, glass textures |
| 7 | Massive choir, orchestral, creature's lament, sub-bass |
| 8 | T1 palette reversed/submerged, glass harmonica, underwater filter |

## Character Voices (Quick)

- **Maren (The Keeper):** Female mezzo A3-E5, texture evolves per track. Dry/close T1-2, increasingly reverbed, underwater by T8. SINGS ALONE until T8.
- **The Ancient Thing:** NOT a voice. Sub-bass + 40-voice glossolalia choir at half-tempo. T7 only. Never speaks words.
- **Logbook Voice:** Maren reading flatly, filtered/crackled. T3 only. 4-6 lines max.
